            ...
            while ($about_us->have_posts()):$about_us->the_post(); ?>
                <div class="col-12 grid-center about-us-content">
                    <div class="col-3_xs-10" push-right="off-1_xs-0">
                        ...
                        <div class="social">
                            <a href="https://www.facebook.com/lotterihnos/" class="fb" target="_blank">/ lotteri
                                hnos</a>
                        </div>
                    </div>
            ...
            <div class="col-11 grid-spaceBetween">
                <?php if ($products->have_posts()):
                    while ($products->have_posts()):$products->the_post();
                        ...
                        ?>
                        <a class="fancybox col-6_xs-12 grid-center prod-container" rel="galery"
                           href="<?php echo $attachment['sizes']['large']; ?>"
                           data-caption="<b><?php the_title(); ?></b><?php the_content(); ?>">
        ...
        <div class="col-8_xs-12 grid-center data">
            <div class="col-5_xs-10">
                ...
                <ul class="contact-data">
                    ...
                    <li class="fb"><a href="https://www.facebook.com/lotterihnos/" target="_blank">/ lotteri hnos</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="col-12 map">
                ...
                <script type='text/javascript'>function init_map() {
                        ...
                        marker = new google.maps.Marker({
                            map: map,
                            position: new google.maps.LatLng(-34.5898073, -58.423439599999995)
                        });
